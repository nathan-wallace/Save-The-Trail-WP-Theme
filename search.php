	...
	<div class="container clearfix">  
		<div class=" clearfix row-fluid">  			
				<div id="main" class="span8 clearfix" role="main">
					...
					<div class="page-header"><h1><span><?php _e("Search Results for","fullfoto"); ?>:</span> <?php echo esc_attr(get_search_query()); ?></h1></div>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<section class="entry-content">
							<?php the_excerpt('<span class="read-more">' . __("Read more on","fullfoto") . ' "'.the_title('', '', false).'" &raquo;</span>'); ?>
