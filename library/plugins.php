...
/*
Fullfoto Plugins & Extra Functionality
Author: Nathan Wallace
URL: http://natewallace.org/
...
function fullfoto_add_user_fields( $contactmethods ) {
	// Add Facebook
...
add_filter('user_contactmethods','fullfoto_add_user_fields',10,1);
